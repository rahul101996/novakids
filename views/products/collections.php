...
<body class="bg-gray-50">
    ...
    <!-- Table Header -->
    <div class="grid grid-cols-[auto_minmax(0,3fr)_minmax(0,1fr)_minmax(0,2fr)_minmax(0,1fr)] items-center gap-4 px-4 py-2 text-gray-500">
        <span>Sr. No</span>
        <span>Title</span>
        <span>Products</span>
        <span>Image</span>
    ...
    <?php foreach ($collections as $key => $collection) { ?>
        <div class="divide-y divide-gray-200">
            <!-- Table Row -->
            <div class="grid grid-cols-[auto_minmax(0,3fr)_minmax(0,1fr)_minmax(0,2fr)_minmax(0,1fr)] items-center gap-4 px-4 py-3 hover:bg-gray-50 text-gray-800">
                <!-- Sr. No -->
                ...
                <div class="flex space-x-2">
                    <a href="/edit-collection/<?= $collection['id'] ?>" class="text-blue-500 hover:text-blue-600"><i class="fa-solid fa-pen"></i></a>
                    <a href="/delete-collection/<?= $collection['id'] ?>" class="text-red-500 hover:text-red-600"><i class="fa-solid fa-trash"></i></a>
                </div>
            </div>
        </div>
    <?php } ?>
