...
<body class="bg-gray-50 bg-gray-100">
    ...
    <div class="flex h-screen ">
        ...
        <main class="flex w-full flex-col items-center justify-start md:ml-60">
            ...
            <form action="" method="POST" enctype="multipart/form-data" class="w-full flex flex-col items-center justify-center">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 w-[85%] pb-10">
                    <div class="lg:col-span-2 flex flex-col gap-6">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-sm">
                            ...
                            <div class="relative flex items-start mt-2">
                                <div class="flex h-5 items-center">
                                    <input id="charge-tax" name="charge_tax" type="checkbox" checked class="h-4 w-4 rounded border-gray-800 text-indigo-600 focus:ring-indigo-500">
                                </div>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-sm">
                            ...
                            <div class="relative flex items-start mt-2">
                                <div class="flex h-5 items-center">
                                    <input name="track_quantity" type="checkbox" checked class="h-4 w-4 rounded border-gray-800 text-indigo-600 focus:ring-indigo-500">
                                </div>
                                <div class="ml-3 text-sm">
                            ...
                            <div class="w-full flex items-center justify-between">
                                ...
                                <input name="quantity" type="number" class="border border-gray-800 rounded-md focus:ring-indigo-500 focus:border-indigo-500 px-3 py-1">
                            </div>
                            <div class="relative flex items-start mt-3">
                                <div class="flex h-5 items-center">
                                    <input id="charge-tax" name="continue_selling" type="checkbox" class="h-4 w-4 rounded border-gray-800 text-indigo-600 focus:ring-indigo-500">
                                </div>
                                <div class="ml-3 text-sm">
                                    <label for="charge-tax" class="font-medium text-gray-700">
                            ...
                            <p class="text-xs text-gray-500">This won't affect Shopify POS. Staff will see a warning, but can complete sales when available inventory reaches zero and below.</p>
                            <div class="relative flex items-start mt-2">
                                <div class="flex h-5 items-center">
                                    <input id="charge-tax" name="sku_barcode" type="checkbox" class="h-4 w-4 rounded border-gray-800 text-indigo-600 focus:ring-indigo-500">
                                </div>
                                <div class="ml-3 text-sm">
                                    <label for="charge-tax" class="font-medium text-gray-700">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-sm">
                            ...
                            <div class="relative flex items-start mt-2">
                                <div class="flex h-5 items-center">
                                    <input id="physical-product" name="physical_product" type="checkbox" checked class="h-4 w-4 rounded border-gray-800 text-indigo-600 focus:ring-indigo-500">
                                </div>
                                <div class="ml-3 text-sm">
                                    <label for="charge-tax" class="font-medium text-gray-700">
                            ...
                            <div class="w-full flex items-center justify-start gap-2 ">
                                <p class="font-semibold !mb-0">Package</p> <span class="rounded-full border-2 border-gray-300 w-5 h-5 flex items-center justify-center pt-[2px]"><i class="fa-solid fa-question text-gray-400 text-xs"></i></span>
                            </div>
                            <div class="relative flex items-start mt-3">
                                <div class="w-full bg-white rounded-lg ">
                                    ...
                                    <div id="dropdown" class="relative">
                                        <button id="dropdownButton" type="button" class="w-full bg-white border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center space-x-2">
                                                    <i class="fas fa-box text-gray-400"></i>
                                                    <div>
                                                        <div class="font-medium">Store default</div>
                                                        <div class="text-xs text-gray-500">Test - 100 × 100 × 100 cm, 1 kg</div>
                                                    </div>
                                                </div>
                                            ...
                                            <?php foreach ($packages as $package) { ?>
                                                <div class="p-2 hover:bg-gray-100 cursor-pointer flex items-center space-x-2" onclick="selectPackage('<?= $package['package_name'] ?>', '<?= $package['length'] ?> × <?= $package['width'] ?> × <?= $package['height'] ?> <?= $package['dimentions_unit'] ?>, <?= $package['weight'] ?> <?= $package['weight_unit'] ?>', '<?= $package['id'] ?>')">
                                                    ...
                                                    ?> <div>
                                                        ...
                                                        <div class="text-xs text-gray-500"><?= $package['length'] ?> × <?= $package['width'] ?> × <?= $package['height'] ?> <?= $package['dimentions_unit'] ?>, <?= $package['weight'] ?> <?= $package['weight_unit'] ?></div>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                ...
                                <div class="flex flex-col items-center justify-center border border-gray-200 rounded-lg w-full">
                                    ...
                                    <div class="flex items-center justify-between w-[95%] py-2">
                                        <button onclick="addOption()" type="button" class="focus:outline-none focus:ring-0">
                                            <i class="fa-solid fa-circle-plus mr-2 border-none" aria-hidden="true"></i> Add another option
                                        </button>

                                        <button onclick="generateVariants()" type="button" class="focus:outline-none focus:ring-0">
                                            <i class="fa-solid fa-layer-group mr-2 border-none" aria-hidden="true"></i> Generate Variants
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="lg:col-span-1 flex flex-col gap-6">
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-sm">
                            ...
                            <div class="space-y-1 text-center flex flex-col items-center border-2 border-gray-800 border-dashed rounded-lg p-8">
