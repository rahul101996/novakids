<aside class="w-60 bg-[#1e293b] text-gray-300 flex flex-col fixed h-full z-10 hidden md:flex">
            <div class="px-6 py-4 border-b border-gray-700">
                <a href="#" class="flex items-center space-x-2 text-white">
                    <img src="/public/logos/white-logo.jpg" class="w-8 h-8" alt="Logo">
            ...
            <!-- Sidebar Navigation -->
            <!-- Sidebar Navigation -->
            <nav class="flex-grow p-4 space-y-2" x-data="{ open: null }">

                <!-- Home -->
                <a href="#" class="flex items-center px-4 py-2 text-white bg-slate-700 rounded-lg">
                ...
                <div>
                    ...
                    <div x-show="open === 'orders'" x-collapse class="ml-10 mt-2 space-y-1">
                        <a href="#all-orders" class="block px-4 py-2 text-sm text-gray-300 hover:bg-slate-700 rounded">
                            All Orders
                        </a>
                        <a href="#cancel-orders" class="block px-4 py-2 text-sm text-gray-300 hover:bg-slate-700 rounded">
                            Cancel Orders
                        </a>
                    </div>
                </div>
                ...
                <div>
                    <button @click="open === 'products' ? open = null : open = 'products'"
                        ...
                        <svg :class="{'rotate-180': open === 'products'}"
                            class="h-4 w-4 transform transition-transform"
                            xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div x-show="open === 'products'" x-collapse class="ml-10 mt-2 space-y-1">
                        ...
                        <a href="#categories" class="block px-4 py-2 text-sm text-gray-300 hover:bg-slate-700 rounded">
                            Categories
                        </a>
                    </div>
                </div>
                <a href="#" class="flex items-center px-4 py-2 hover:bg-slate-700 rounded-lg text-gray-300 hover:text-white text-decoration-none">
