...
<header class="w-full flex bg-[#1a1a1a] items-center justify-between fixed top-0 left-0 z-[9999] py-2">
    <div class="flex items-center justify-center px-4 py-2 gap-1">
        <img alt="Shopify" src="https://cdn.shopify.com/shopifycloud/web/assets/v1/vite/client/en/assets/shopify-glyph-white-DZNyE9BvHIk-.svg" class="h-[1.6rem]">
        <img alt="Shopify" src="https://cdn.shopify.com/shopifycloud/web/assets/v1/vite/client/en/assets/shopify-wordmark-monochrome-CpVsfBAAmxEP.svg" class="h-[1.4rem] mt-1">
    </div>
    ...
    <div class="flex items-center space-x-5 px-4">
        ...
        <div class="flex items-center space-x-2">
            <div class="w-10 h-10 bg-fuchsia-600 rounded-xl flex items-center justify-center text-white font-semibold text-sm">
                NV
            </div>
            <span class="text-right text-sm">
                <span class="font-semibold text-gray-300">NovaKids</span>
            </span>
