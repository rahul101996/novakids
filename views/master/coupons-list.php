                ...
                <div class="w-[97%] flex items-start justify-center gap-3 flex-col bg-white rounded-2xl overflow-y-auto">
                    <div class="w-full flex items-center justify-between mt-2 px-2">
                        <div class="relative w-[45vw]">
                            ...
                            <input type="text" placeholder="Search for a coupon" class="bg-white w-full pl-10 pr-4 py-1 rounded-xl  focus:border-gray-200 focus:bg-gray-100 placeholder:text-[#626262] outline-none transition">
