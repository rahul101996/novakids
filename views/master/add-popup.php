    ...
    <div class="flex">
        ...
        <main class="flex-1 md:ml-[16.5rem] md:mt-[3.7rem] bg-[#f1f1f1] rounded-tr-3xl  h-[92vh] overflow-y-scroll">
            ...
            <div class="w-full flex items-center justify-center p-3">
                <span class="text-xl font-semibold text-gray-800 w-[87%]">Add POP</span>
            ...
            <div class="w-full flex items-center justify-center pb-4 ">
                ...
                <form action="" method="POST" class="w-[85%]" enctype="multipart/form-data">
                    ...
                    <div class="lg:col-span-2 flex flex-col gap-6">
                        ...
                        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                            ...
                            <input
                                class="w-full border-[1px] border-gray-600 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 px-3 py-1" value="<?= isset($popup['title']) ? $popup['title'] : '' ?>" name="title"
                                id="title" type="text" />
                            <label class="block text-sm font-medium text-gray-700 mt-6 mb-1"
                                for="description">Description</label>
                            <div class="border border-gray-300 rounded-md">
                                <textarea class="w-full h-40 border-[1px] border-gray-600 focus:ring-0 resize-y p-3"
                                    placeholder="" name="description"><?= isset($popup['description']) ? $popup['description'] : '' ?></textarea>
                            </div>
                    ...
                    <div class="lg:col-span-1 flex flex-col gap-6">
                        ...
                        <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                            ...
                            <div class="space-y-1 text-center flex flex-col items-center border-2 border-gray-300 border-dashed rounded-lg p-8">
                                ...
                                <div id="imagePreview" class="<?= isset($popup['img']) ? '' : 'hidden' ?> mb-4">
                                    <input type="hidden" name="old_image" value="<?= isset($popup['img']) ? $popup['img'] : '' ?>">
                                    <img src="/<?= isset($popup['img']) ? $popup['img'] : '' ?>" alt="Preview" class="mx-auto h-32 object-cover">
                                </div>
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="vdata_image" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none">
                                        ...
                                        <input id="vdata_image" name="img" type="file" class="sr-only" accept="image/*" <?= isset($popup['img']) ? '' : 'required' ?>>
                                    </label>
                ...
                <div class="w-[85%]">
                    <button class="bg-black border border-transparent rounded-md py-2 px-4 text-sm font-medium text-white  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" name="<?= isset($popup['id']) ? 'update' : 'add' ?>">Save</button>
                </div>
            </form>
        </main>
    </div>
