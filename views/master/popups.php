    ...
    <div class="flex">
        ...
        <main class="flex-1 md:ml-[16.5rem] md:mt-[3.7rem] bg-[#f1f1f1] rounded-tr-3xl  h-[92vh] overflow-y-scroll">
            ...
            <div class="w-full flex items-center justify-between p-3">
                <span class="text-xl font-semibold text-gray-800">Popups</span>
                <a href="/admin/add-popup" class="bg-gray-800 text-sm font-semibold py-2 px-4 rounded-lg text-white">Add Popup</a>
            </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr
                                    ...
                                    <td class="font-semibold py-2 px-3 text-left">
                                        <img src="/<?= htmlspecialchars($banner['img']) ?>" class="h-24 rounded"
                                            alt="Category Image">
                                    </td>
                                    ...
                                    <td class="font-semibold py-2 px-3 text-right">
                                        <div class="flex space-x-2 justify-end">
                                            ...
                                            <a href="/edit-popup/<?= $banner['id'] ?>" class="text-black hover:text-black"><i class="fa-solid fa-pen"></i></a>
                                            <a href="/delete-popup/<?= $banner['id'] ?>" class="text-red-700 hover:text-red-600"><i class="fa-solid fa-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
