                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full pb-10">
                        <div class="lg:col-span-2 flex flex-col gap-6">
                            ...
                            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                                ...
                                <label class="block text-sm font-medium text-gray-700 mt-6 mb-1" for="description">Active Discount</label>
                                <div class="border-[1px] border-gray-600 rounded-md px-4 py-3">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <label for="free_shipping" class="text-sm text-gray-700">Enable Discount</label>
                                    </div>
