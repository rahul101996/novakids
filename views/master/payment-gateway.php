                    ...
                    <div class="card card-primary card-outline card-tabs mt-2">
                        <div class="card-header p-0 pt-1 border-bottom-0">
                            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active font-semibold" id="custom-tabs-three-home-tab" data-toggle="pill" href="#custom-tabs-three-home" role="tab" aria-controls="custom-tabs-three-home" aria-selected="true">Cashfree</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link font-semibold" id="custom-tabs-three-profile-tab" data-toggle="pill" href="#custom-tabs-three-profile" role="tab" aria-controls="custom-tabs-three-profile" aria-selected="false">Razorpay</a>
                                </li>
                                    ...
                                    <form action="" method="POST" class="col-md-12 row" enctype="multipart/form-data">
                                        <div class=" flex flex-col w-[50%] ">
                                            ...
                                            <div class="form-group mb-3 col-sm-6">
                                                ...
                                                if (empty($editData)) {
                                                ?>
                                                    <button type="submit" name="cashfree" class="bg-black text-white px-3 py-1 rounded-lg font-semibold">Submit</button>
                                                <?php
                                                } else {
                                                ?>
                                                    <input type="hidden" value="<?= $editData["img"] ?>" name="oldimg">
                                                    <button type="submit" name="cashfree" class="bg-black text-white px-3 py-1 rounded-lg font-semibold">Update</button>
                                                <?php
                                                }
                                                ?>
                                            </div>
                                    ...
                                    <form action="" method="POST" class="col-md-12 row" enctype="multipart/form-data">
                                        <div class=" flex flex-col w-[50%] ">
                                            ...
                                            <div class="form-group mb-3 col-sm-6">
                                                ...
                                                if (empty($editData)) {
                                                ?>
                                                    <button type="submit" name="razorpay" class="bg-black text-white px-3 py-1 rounded-lg font-semibold">Submit</button>
                                                <?php
                                                } else {
                                                ?>
                                                    <input type="hidden" value="<?= $editData["img"] ?>" name="oldimg">
                                                    <button type="submit" name="razorpay" class="bg-black text-white px-3 py-1 rounded-lg font-semibold">Update</button>
                                                <?php
                                                }
                                                ?>
                                            </div>
