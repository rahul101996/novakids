    ...
    <div class="min-h-screen">
        ...
        <div class="w-full flex items-center justify-center py-16 max-lg:py-10">
            <div class="w-[80%] flex flex-col items-center justify-center max-md:w-[85%] max-lg:w-[90%]">
                ...
                <h1 class="w-full text-4xl font-semibold mt-10 max-lg:text-3xl">SSC CGL

                </h1>
                <p class="text-gray-500 mt-5">Staff Selection Commission (SSC) is a Government organization that recruits staff for various posts in the various Ministries and Departments of the Government of India and in Subordinate Offices.
                </p>
                <p class="text-gray-500 mt-5 w-full max-lg:mb-2">SSC broadly conducts two types of examinations.
                </p>
                ...
                <div class="flex items-center justify-start gap-3 w-full">
                    <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                    <p>SSC Combined Matric Level Examination i.e. SSC 10+2
                    ...
                    <div class="w-[70%] flex flex-col items-center justify-center max-lg:w-full max-lg:gap-2">
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col" id="profileForm">
                            <div class="space-y-6 max-lg:w-full  max-lg:mx-auto">
                                <!-- Exam Overview -->
                                <div>
                                    <h2 class="text-2xl font-semibold mb-2">📝 SSC CGL Exam Overview</h2>
                                    <p class="text-gray-700">
                                        SSC CGL (Combined Graduate Level) Exam is conducted by the Staff Selection Commission (SSC) to recruit candidates for various Group B and Group C posts in ministries, departments, and organizations of the Government of India.
                                    </p>
                                </div>

                                <!-- Authority & Frequency -->
                                <div>
                                    <h2 class="text-xl font-semibold mb-2">📌 Exam Conducting Authority</h2>
                                    <p class="text-gray-700 mb-1">Staff Selection Commission (SSC)</p>

                                    <h2 class="text-xl font-semibold mb-2">📅 Exam Frequency</h2>
                                    <p class="text-gray-700 mb-1">Once a year</p>

                                    <h2 class="text-xl font-semibold mb-2">🎯 Purpose of the Exam</h2>
                                    <p class="text-gray-700">To recruit graduates for various central government jobs in non-gazetted posts.</p>
                                </div>

                                <!-- Popular Posts -->
                                <div>
                                    <h2 class="text-xl font-semibold mb-2">📂 Popular Posts under SSC CGL</h2>
                                    <ul class="list-disc pl-6 text-gray-700 grid grid-cols-2 gap-y-1 max-sm:grid-cols-1">
                                        ...
                                        <li>Assistant Enforcement Officer</li>
                                        <li>Sub-Inspector (CBI, NIA)</li>
                                        <li>Junior Statistical Officer (JSO)</li>
                                        <li>Auditor / Accountant (CAG, CGDA)</li>
                                        <li>Assistant in Ministry of External Affairs</li>
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-700"><strong>Education:</strong> Bachelor’s Degree in any discipline from a recognized university.</p>
                                    <p class="text-gray-700 mt-1"><strong>Age Limit:</strong> Varies post-wise (generally between 18 to 32 years). Age relaxation for reserved categories.</p>
                                </div>

                                <!-- Exam Pattern -->
                                <div>
                                    <h2 class="text-xl font-semibold mb-2">🏛️ Exam Pattern</h2>

                                    <!-- Tier-I -->
                                    <div class="max-lg:text-xs">
                                        <h3 class="text-lg font-semibold mb-1">✅ Tier-I (Computer Based Test)</h3>
                                        <div class="overflow-x-auto mb-2 max-lg:mt-8">
                                            <table class="w-full text-left text-gray-500 border border-gray-200">
                                                <thead class="text-gray-700 uppercase bg-gray-50">
                                                    <tr>
                                                        ...
                                                        <th class="px-6 py-3">Negative Marking</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr class="bg-white border-b border-gray-200">
                                                        <td class="px-6 py-4">General Intelligence & Reasoning</td>
                                                        <td class="px-6 py-4">25</td>
                                                        <td class="px-6 py-4">50</td>
                                                        <td class="px-6 py-4" rowspan="4">60 Minutes</td>
                                                        <td class="px-6 py-4" rowspan="4">0.50 mark</td>
                                                    </tr>
                                                    <tr class="bg-white border-b border-gray-200">
                                                    ...
                                                    <tr class="bg-white border-b border-gray-200">
                                                        <td class="px-6 py-4">English Comprehension</td>
                                                        <td class="px-6 py-4">25</td>
                                                        <td class="px-6 py-4">50</td>
                                                    </tr>
                                                </tbody>
                                    ...
                                    <!-- Tier-II -->
                                    <div>
                                        <h3 class="text-lg font-semibold mb-1 mt-4">✅ Tier-II (Computer Based Test)</h3>
                                        <ul class="list-disc pl-6 text-gray-700 space-y-1">
                                            <li><strong>Paper-I:</strong> Quantitative Abilities & Reasoning</li>
                                            <li><strong>Paper-II:</strong> English Language and Comprehension</li>
                                            <li><strong>Paper-III:</strong> Statistics (for JSO)</li>
                                            <li><strong>Paper-IV:</strong> General Studies (Finance and Economics) – for Assistant Audit/Accounts Officer</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <!-- Selection Process -->
                                <div>
                                    <h2 class="text-xl font-semibold mb-2">📋 Selection Process</h2>
                                    <ul class="list-disc pl-6 text-gray-700 space-y-1">
                                        <li>Tier-I (Preliminary)</li>
                                        <li>Tier-II (Mains)</li>
                                        <li>Document Verification</li>
                                        <li>Medical Examination (where applicable)</li>
                                    </ul>
                                </div>

                                <!-- Job Locations -->
                                <div>
                                    <h2 class="text-xl font-semibold mb-2">💼 Job Locations</h2>
                                    <p class="text-gray-700">Pan India (based on the post and preference)</p>
                                </div>

                                <!-- Career Growth -->
                                <div>
                                    <h2 class="text-xl font-semibold mb-2">📈 Career Growth</h2>
                                    <p class="text-gray-700">SSC CGL offers excellent promotion opportunities, government perks, and job stability.</p>
                                </div>
                            </div>
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-2" id="passwordForm">
                            ...
                            <div class="flex items-center justify-start gap-3 w-full mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>For the post of Compiler: Bachelor’s degree from any recognized university with Economics⁄Statistics⁄Mathematics as compulsory or elective subject.
                                </p>
                            </div>
                            <div class="flex items-center justify-start gap-3 w-full mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>For the post of Statistical Investigator Grade – II: Bachelor’s degree in any discipline from a recognized University with:
                            ...
                            <div class="flex items-center justify-start gap-3 w-full mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>For all other posts: Bachelor’s degree in any discipline from a recognized University or any other equivalent qualification.
                                </p>
                            </div>
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-4" id="key_benefits">
                            <div class="flex items-center justify-start gap-3 w-full mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>Salary of SSC CGL Officer is really very high with multiple benefits.
                                </p>
                            </div>
                            <div class="flex items-center justify-start gap-3 w-full mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>Financial stability is guaranteed under this cadre.
                                </p>
                            </div>
                            <div class="flex items-center justify-start gap-3 w-full mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>SSC keeps conducting grade–wise departmental competitive exams for existing Central Government staff members. This provides them with ample growth prospects.
                                </p>
                            </div>
