...
<body>
    ...
    <div class="min-h-screen">
        ...
        <div class="w-full flex items-start justify-center py-16 max-lg:py-5 min-h-[100vh]  relative">


            <div class="w-[80%] flex items-center justify-center flex-col section_paragraph section_paragraph--visible max-lg:w-[90%]">
                <span class="text-[#065caa]">Recent Posts

                </span>
                <div class="w-full flex items-center justify-center">
                    <div class="w-fit relative ">
                        <h2 class="text-5xl max-lg:text-2xl font-semibold mt-2 text-center">Recent Blogs &amp; News
                        </h2>
                        <!-- <img src="/public/images/shape.png" class="absolute -top-10 -right-24" alt=""> -->
                    </div>

                </div>
                <div class="w-full grid grid-cols-3 gap-5 mt-10 items-center justify-center max-lg:grid-cols-2 max-md:grid-cols-1">
                    <?php
                    ...
                    ?>
                        <div class="w-full border border-gray-200 flex items-center justify-center flex-col">
                            <div class="w-full flex items-center justify-center h-[35vh] max-lg:h-full">
                                <img src="/<?= $blog['image']; ?>" class="w-full h-full object-cover " alt="">
                            </div>
                            <div class="w-full p-5 flex flex-col items-start justify-center">
                                <div class="flex items-center justify-center gap-3">
                                    <!-- <span class="text-xs rounded-full py-1 bg-[#efe9fe] px-3">EDUCATION</span> -->
                                    <div class="bg-gray-300 w-[30px] h-[1px]"></div>
                                    <span class="text-xs"><?= formatDate($blog['date']); ?></span>
                                </div>
                                <h2 class="mt-4 text-2xl max-lg:text-lg font-semibold"><?= $blog['name']; ?></h2>
                                <div class="flex items-center justify-center gap-3 mt-2 text-gray-500 text-sm">
                                    <p><?= $blog['subtitle']; ?></p>
                                    <!-- <span class="text-sm">Ralph Edwards</span> -->
                                </div>
                            </div>
                            <a href="/blog/<?= $url; ?>" class="w-full pl-5 pb-2 text-blue-500">Read More</a>
                        </div>
                    <?php
                    }
                    ?>
        ...
        <div class="w-full flex items-center justify-center">
            <div class="w-[80%] flex flex-col items-center justify-center gap-4 max-md:w-[85%] max-lg:w-[90%]">
                        <div class="w-full h-[1px] bg-gray-300 mb-7"></div>
