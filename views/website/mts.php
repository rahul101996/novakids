    ...
    <div class="min-h-screen">
        ...
        <div class="w-full flex items-center justify-center py-16 max-lg:py-10">
            <div class="w-[80%] flex flex-col items-center justify-center max-md:w-[85%] max-lg:w-[90%]">
                ...
                <h1 class="w-full text-4xl font-semibold mt-10">SSC MTS


                </h1>
                <p class="text-gray-500 mt-5">For all those with just minimum education, SSC MTS recruitment is a good chance to apply for govt jobs in India.It is conducted to fill multi tasking staff (MTS) vacancies in various ministries & departments of the central government.Although the number of candidates who apply for MTS recruitment keeps increasing every year, many don’t know about the job profile of MTS cadre employees.


                </p>
                <p class="text-gray-500 mt-5 w-full">Apart from Indian civil services (IAS, IPS, IFS etc.,) there are other jobs in central govt that are categorized under Group B, C & D.A total of approx 15 – 20,000 jobs are being created every year in these govt depts through this route.
                </p>
                <p class="text-gray-500 mt-5 w-full">Inorder to qualify for these jobs, candidates must qualify in exams such as SSC CGL, SSC CHSL SSC JE etc., conducted by Staff Selection Commission (SSC).
                ...
                <div class="w-full flex items-start justify-center mt-10 gap-5 max-lg:flex-col max-lg:gap-2">
                    <div class="w-[70%] flex flex-col items-center justify-center max-lg:w-full max-lg:gap-2">
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col" id="profileForm">
                            <div class="space-y-6 max-lg:w-full max-lg:mx-auto">
                                <!-- Exam Overview -->
                                <div>
                                    <h2 class="text-2xl font-semibold mb-2">📝 SSC MTS Exam Overview</h2>
                                    <ul class="list-disc pl-6 text-gray-700 space-y-1">
                                        <li><strong>Full Form:</strong> Staff Selection Commission - Multi-Tasking (Non-Technical) Staff Examination</li>
                                        <li><strong>Conducting Body:</strong> Staff Selection Commission (SSC)</li>
                                        <li><strong>Level:</strong> National-level Exam</li>
                                        <li><strong>Mode of Exam:</strong> Online (Computer-Based Test)</li>
                                    </ul>
                                </div>

                                <!-- Key Posts -->
                                <div>
                                    <h2 class="text-xl font-semibold mb-2">📌 Key Posts under SSC MTS</h2>
                                    <ul class="list-disc pl-6 text-gray-700 grid grid-cols-2 gap-y-1 max-sm:grid-cols-1">
                                        <li>Peon</li>
                                        <li>Daftary</li>
                                        <li>Jamadar</li>
                                ...
                                <!-- Exam Pattern -->
                                <div>
                                    <h2 class="text-xl font-semibold mb-2">📚 Exam Pattern</h2>
                                    <p class="text-gray-600 mb-2">Paper-I (Computer-Based Test)</p>

                                    <div class="overflow-x-auto max-lg:mt-8 max-lg:text-xs">
                                        <table class="w-full text-left rtl:text-right text-gray-500 border border-gray-200">
                                            <thead class="text-gray-700 uppercase bg-gray-50">
                                                <tr>
                                                    ...
                                                    <th scope="col" class="px-6 py-3">Time Duration</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr class="bg-white border-b border-gray-200">
                                                    <td class="px-6 py-4">1</td>
                                                    <td class="px-6 py-4">Numerical and Mathematical Ability</td>
                                                    <td class="px-6 py-4">20</td>
                                                    <td class="px-6 py-4">60</td>
                                                    <td class="px-6 py-4 text-center" rowspan="4">90 Minutes</td>
                                                </tr>
                                                <tr class="bg-white border-b border-gray-200">
                                                    <td class="px-6 py-4">2</td>
                                                    <td class="px-6 py-4">Reasoning Ability and Problem Solving</td>
                                                    <td class="px-6 py-4">20</td>
                                                    <td class="px-6 py-4">60</td>
                                                </tr>
                                                <tr class="bg-white border-b border-gray-200">
                                                ...
                                                <tr class="bg-white border-b border-gray-200">
                                                    ...
                                                    <td class="px-6 py-4">English Language and Comprehension</td>
                                                    <td class="px-6 py-4">25</td>
                                                    <td class="px-6 py-4">75</td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <p class="text-sm text-gray-500 mt-2">
                                        <strong>Negative Marking:</strong> 1 mark for each wrong answer in Session 2.
                                    </p>
                                </div>

                                <!-- Eligibility -->
                                <div>
                                    <h2 class="text-xl font-semibold mb-2">✅ Eligibility Criteria</h2>
                                    <p class="text-gray-700"><strong>Age Limit:</strong></p>
                                    <ul class="list-disc pl-6 text-gray-600 space-y-1 mb-2">
                                        <li>18 to 25 years (for most posts)</li>
                                        <li>18 to 27 years (for some posts with special requirements)</li>
                                    </ul>

                                    <p class="text-gray-700"><strong>Educational Qualification:</strong></p>
                                    <p class="text-gray-600 mb-2">Must have passed 10th Class (Matriculation) from a recognized board.</p>
                                </div>

                                <!-- Important Points -->
                                <div>
                                    <h2 class="text-xl font-semibold mb-2">📅 Important Points</h2>
                                    <ul class="list-disc pl-6 text-gray-700 space-y-1">
                                        <li>No interview or physical test for MTS posts (except for Havaldar post in CBIC/CBN which includes a Physical Test)</li>
                                        <li>Reserved category candidates get age relaxation as per government norms</li>
                                        <li>SSC MTS is a good entry-level opportunity for government jobs</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-2" id="passwordForm">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    <h2 class="text-xl font-semibold">1. Nationality / Citizenship</h2>
                                    ...
                                    <ul class="list-disc pl-6 text-gray-600 space-y-1 mt-2">
                                        ...
                                        <li>A Tibetan refugee who came to India before January 1, 1962, intending to settle here permanently, or</li>
                                        <li>A person of Indian origin who migrated from Pakistan, Burma, Sri Lanka, East African countries etc. with the intention of permanent settlement in India.</li>
                                    </ul>
                                    <p class="text-sm text-gray-500 mt-2">
                                        <strong>Note:</strong> Candidates other than Indian citizens need to have a certificate of eligibility issued by the Government of India.
                                    </p>
                                </div>

                                <!-- 2. Age Limit -->
                                <div>
                                    <h2 class="text-xl font-semibold">🔹 2. Age Limit (as on cut-off date mentioned in notification)</h2>
                                    <p class="text-gray-700 mt-2">SSC MTS has two age groups:</p>
                                    <ul class="list-disc pl-6 text-gray-600 space-y-1 mt-2">
                                        <li><strong>18 to 25 years:</strong> For most MTS posts.</li>
                                        <li><strong>18 to 27 years:</strong> For certain posts where age relaxation is applicable.</li>
                                    </ul>
                                </div>

                                <!-- 3. Educational Qualification -->
                                <div>
                                    <h2 class="text-xl font-semibold"> 🔹 3. Educational Qualification</h2>
                                    <p class="text-gray-700 mt-2">
                                        Must have passed 10th Class / Matriculation or equivalent examination from a recognized board as on the date specified in the notification.
                                    </p>
                                    <p class="text-sm text-gray-500 mt-2">
                                        <strong>Note:</strong> Candidates appearing in the 10th exam are not eligible unless they have cleared it before the application closing date.
                                    </p>
                                </div>

                                <!-- 4. Physical Standards -->
                                <div>
                                    <h2 class="text-xl font-semibold">🔹 4. Physical Standards (only for Havaldar post)</h2>
                                    <p class="text-gray-700 mt-2">
                                        For SSC Havaldar posts (CBIC & CBN), physical tests like walking and height/chest measurement are required.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-4" id="key_benefits">
                            <div class="flex items-center justify-start gap-3 w-full mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>All those who are applying for SSC MTS recruitment 2017 have one question in mind – What is the take home salary of multi tasking staff (MTS).
                            ...
                            <div class="flex items-center justify-start gap-3 w-full mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>Multi Tasking Staff is a general central service group ‘C’ non-gazetted, non-ministerial post that falls under Payband-1 (Rs.5200 – 20200) + Grade Pay Rs.1800.
                                </p>
                            </div>
                            <div class="flex items-center justify-start gap-3 w-full mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>The take-home salary of MTS ranges between Rs.18,000 – 22,000 /month (approx). Since MTS staff are posted in different depts & states, the salary could vary slightly based on location, allowances etc.
                                </p>
                            </div>
