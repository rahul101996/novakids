    ...
    <div class="min-h-screen">
        ...
        <div class="w-full flex items-center justify-center py-16 max-lg:py-10">
            <div class="w-[80%] flex flex-col items-center justify-center max-md:w-[85%] max-lg:w-[90%] ">
                ...
                <h1 class="w-full text-4xl font-semibold mt-10">MH-CET</h1>
                <p class="text-gray-500 mt-5">MAH-MBA CET exam is the official gateway for admissions to all the AICTE approved, University, University affiliated and private aided or unaided B-schools in the State of Maharashtra. Approximately 59000 candidates are offered admission in the MBA/MMS/PGDM programmes in the B-schools across Maharashtra on the basis of MAHCET scores as well as All India MBA entrance exam scores like CAT, XAT, CMAT, MAT, ATMA and GMAT.
                </p>
                ...
                <div class="w-full flex items-start justify-center mt-10 gap-5 max-lg:flex-col max-lg:gap-2">
                    <div class="w-[70%] flex flex-col items-center justify-center max-lg:w-full max-lg:gap-2">
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col" id="profileForm">
                            <p class="text-gray-500 mt-2">MAHCET MBA entrance test is an online computer based exam of 2½ hours duration. The exam consists of 200 questions in MCQ format. The best part is there is no negative marking in MAHCET MBA entrance exam.</p>
                            <p class="text-gray-500 mt-2">
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-" id="passwordForm">
                            <h2 class="text-3xl font-semibold max-lg:text-lg">MAH-CET has following major points that determine the eligibility criteria to appear in the exam


                            </h2>
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Applicant must be a citizen of India.
                                </p>
                            </div>

                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Graduates with 50% marks in any discipline can apply for MAHCET MBA/MMS exam.
                                </p>

                            </div>
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Final year students of Graduate Courses (10+2+3) whose result will be declared before commencement of admission for academic year 2018-19 can also apply for MAHCET online exam.
                                </p>

                            </div>
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Registration fee for MAHCET exam is Rs.1000/- for all India candidates and Rs.800/- for reserved category candidates.
                                </p>

                            </div>
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">The candidates can seek admission in Maharashtra B-schools on the basis of other All India MBA entrance exams also.
                                </p>

                            </div>

                            <h2 class="text-xl font-semibold mt-5">Eligibility: Maharashtra State (MS) Candidate</h2>
                            <p class="text-gray-500 mt-2">Qualifying on any of the 4 types could place your candidature as the Maharashtra State (MS) candidate. Registering and applying for MAHCET 2018 as MS candidate will open more opportunities and more admission options in MBA/MMS 2018-20 in top MBA colleges in Maharashtra.

                            </p>
                            <h2 class="text-xl font-semibold mt-5">MS candidate: Type A </h2>
                            <p class="text-gray-500 mt-2">An aspirant who has passed HSC and qualifying examination from Maharashtra state is a Maharashtra Candidate. If the applicant didn’t pass HSC but passed Diploma in Engineering / Technology / Pharmacy and any other qualifying examination from Maharashtra State, he/she is to be termed as Maharashtra State Candidate. In addition to this fact, if the Candidate is Domiciled or Born in the State of Maharashtra, he/she is the Maharashtra State Candidate and should mention it while registering and applying for MAHCET 2018 online.
                            </p>
                            <h2 class="text-xl font-semibold mt-5">MS Candidate: Type B

                            </h2>
                            <p class="text-gray-500 mt-2">You could be Maharashtra State (MS) Candidate if you or your Father or Mother is domiciled in the State of Maharashtra. It is not necessary that you were born or studied in the State of Maharashtra. In case it is the place of domicile of any 3 of you as shared above, you could reap the benefits of being an MS candidate.


                            </p>
                            <h2 class="text-xl font-semibold mt-5">MS Candidate: Type C

                            </h2>
                            <p class="text-gray-500 mt-2">If either of your parents i.e. Father or Mother, is an employee of the Government of India or Government of India Undertaking who is posted and reported to duty in Maharashtra State before the last date for submitting the application for admission, you are a Maharashtra State candidate.


                            </p>
                            <p class="text-gray-500 mt-2">If you wish to appear in MAHCET 2018 as a Maharashtra State candidate and your parents are supposed to report for duty in Maharashtra state but are delaying it, if they report for duty you can apply for MAHCET 2018 as an MS candidate to gain all the benefits of Maharashtra State candidature.

                            </p>
                            <h2 class="text-xl font-semibold mt-5">MS Candidate: Type D
                            </h2>
                            <p class="text-gray-500 mt-2">An applicant will be considered as Maharashtra State Candidate if his/her Father or Mother is an employee of the Government of Maharashtra/Government of Maharashtra Undertaking. Although such employees are usually not posted out of the state, in case they are posted in some other states or are on deputation to some other departments, the candidate would still be considered as Maharashtra state candidate.


                            </p>
                            <h2 class="text-xl font-semibold mt-5">All India candidates: 15% to 35% seats reserved
                            </h2>
                            <p class="text-gray-500 mt-2">15% to 35% seat allocation is available for All India candidates appearing in MAH-CET exam. These candidates are also offered admission on the basis of their scores in All India MBA entrance exams like CAT, XAT, CMAT, MAT, ATMA.
                            </p>
                            <h2 class="text-xl font-semibold mt-5">JBIMS Mumbai: May have different eligibility
                            </h2>
                            <p class="text-gray-500 mt-2">For the batch 2018-20, JBIMS Mumbai may opt for different eligibility and may not offer admission through DTE CAP round. It may accept only CAT and MAH-CET scores. So the eligible candidates may be required to apply to JBIMS, Mumbai separately apart from registering for MAH CET 2018.
                            </p>

                            <h2 class="text-2xl font-semibold mt-5">MAH CET Registration & Application process
                            </h2>
                            <p class="text-gray-500 mt-2">
                                Online Registration for MAHCET through computer connected to Internet on the web site www.dtemaharashtra.gov.in/mba would open in January . The registration process, according to the past trends announced by DTE Maharashtra would close in February. The Registration and application form to apply for MAHCET should be completed online. DTE Maharashtra will reject the registration form if it is submitted by post or courier.
                            </p>
                            <h2 class="text-xl font-semibold mt-5">Application fee


                            </h2>
                            <p class="text-gray-500 mt-2">Application form processing fee is Rs. 1000/- for open category and Rs.800/- for reserved category and should be paid through online system only by Internet Payment, Credit Card/ Debit Card payment gateway for which the service charges, as per rules, shall be applicable in addition to the application form processing fees. No other mode of payment shall be permitted.


                            </p>
                            <h2 class="text-xl font-semibold mt-5">For Open category
                            </h2>
                            <p class="text-gray-500 mt-2">Application fee for open Category Candidates from Maharashtra State, Outside Maharashtra State (OMS), J & K Migrant candidates and NRI/Foreign Nationals / PIO/Children of Indian Workers in the Gulf Countries Candidates is Rs.1000/- (Rs. One thousand only)
                            </p>
                            <h2 class="text-xl font-semibold mt-5">For Reserved category
                            </h2>
                            <p class="text-gray-500 mt-2">Application fee for candidates of Backward Class Categories [SC, ST, VJ/DT- NT(A), NT(B), NT(C), NT(D), OBC, SBC] and & Persons with Disability Candidates belonging to Maharashtra State only is Rs.800/- (Rs. Eight hundred only)
                            </p>
                            ...
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">MAH-CET will remain an online exam for admission to AICTE approved MBA/MMS/ PGDM courses batch in B-schools across the state of Maharashtra. No structural and content based changes in MAHCET are proposed by DTE Maharashtra. Following are the key features of MAHCET
                                </p>

                            </div>
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Test window would be of 2 days divided in multiple sessions
                            ...
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">MAH MBA-CET will be conducted in online mode.
                            ...
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">The test will be of 150 minutes (2 and half hours) duration
                            ...
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">The test will consist of only Multiple Choice Questions (MCQs).
                            ...
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Total number of questions will be 200
                            ...
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">There will be 5 answer options for each question.
                                </p>

                            </div>
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">The questions will not carry negative marking for any wrong answer.
                            ...
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Exam will consist of 3 sections while Reasoning section will contain Logical & Abstract Reasoning questions separately
                                </p>
                            ...
                            <div class="relative overflow-x-auto w-full mt-5">
                                <table class="w-full text-left rtl:text-right text-gray-500 ">
                                    <thead class=" text-gray-700 uppercase bg-gray-50  ">
                                        ...
                                        <tr class="bg-white border-b  dark:border-gray-200 border-gray-200">
                                            <td class="px-6 py-4">Abstract Reasoning</td>
                                        ...
                                        <tr class="bg-white border-b  dark:border-gray-200 border-gray-200">
                                            <td class="px-6 py-4">Quantitative Aptitude</td>
                                        ...
                                        <tr class="bg-white border-b  dark:border-gray-200 border-gray-200">
                                            <td class="px-6 py-4">Verbal Ability/Reading Comprehension</td>
                                            <td class="px-6 py-4">50</td>
                                            <td class="px-6 py-4">1</td>
                                            <td class="px-6 py-4">50</td>
                                            <!-- <td class="px-6 py-4 text-nowrap ">20 Minutes</td> -->
                                        ...
                                        <tr class="bg-white border-b  dark:border-gray-200 border-gray-200">
                                            <td class="px-6 py-4 text-left font-semibold" colspan="3">Total marks for the test</td>
                            ...
                            <h2 class="text-xl font-semibold mt-5">MAHCET 2018 Exam Syllabus</h2>
                            <p class="text-gray-500 mt-2">The exam is divided in 3 sections. One of the 3 sections has 2 distinct parts – Logical Reasoning and Abstract reasoning with varying number of questions. The online test contains all MCQs only. The syllabus for MAHCET as per DTE Maharashtra is as follows-

                            </p>
                            <h3 class="text-lg font-semibold mt-5">Logical and Abstract Reasoning

                            </h3>
                            <p>This shall include questions to measure how quickly and accurately you can think. The section may have questions based on figures and diagrams and also on Verbal Reasoning.

                            </p>
                            <h3 class="text-lg font-semibold mt-5">Quantitative Aptitude
                            </h3>
                            <p>This shall include questions to know how fast and accurate you can work with numbers, do numerical calculations, understand various arithmetic problems involving ratio & proportion, percentage etc. This test also helps to measure your power of quantitative reasoning, interpretation of tables, common graphs & charts.



                            </p>
                            <h3 class="text-lg font-semibold mt-5">Verbal Ability & Reading Comprehension



                            </h3>
                            <p>This shall include the passages with questions based on their contents to test your comprehension. Your English language ability would be tested through questions on Grammar, vocabulary, sentence completion, synonyms, antonyms, comprehension of passages etc. Your English language ability would be tested through questions on (1) understanding of the contents of the passages and (2) choice of appropriate words, phrases, expressions and similar language skills.
