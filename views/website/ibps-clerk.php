    ...
    <div class="min-h-screen">
        ...
        <div class="w-full flex items-center justify-center py-16 max-lg:py-10">
            <div class="w-[80%] flex flex-col items-center justify-center max-md:w-[85%] max-lg:w-[90%]">
                ...
                <h1 class="w-full text-4xl font-semibold mt-10">IBPS CLERK Exams </h1>
                <p class="text-gray-500 mt-5">IBPS (Institute of Banking Personnel Selection) conducts a Common Written Exam or CWE every year for the clerical cadre in multiple banks all over the country. All public sector banks use CWE as a base to fill the vacancies for this post.
                </p>
                <p class="text-gray-500 mt-5 w-full text-left">
                ...
                <div class="w-full flex items-start justify-center mt-10 gap-5 max-lg:flex-col max-lg:gap-2">
                    <div class="w-[70%] flex flex-col items-center justify-center max-lg:w-full max-lg:gap-2">
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col" id="profileForm">
                            <h2 class="text-2xl font-semibold">IBPS Clerk Preliminary Examination</h2>
                            <p class="text-gray-500 mt-2">The preliminary exam of IBPS Clerk CWE is an online exam testing a candidate on the basis of their aptitude, intellect and English. There are three sections in total and the candidate must clear the cut off of each section to proceed to the mains exam round. Candidates are required to solve the question paper in the time frame of 1 hour. The composite marks of the paper are 100 and the passing marks are decided by IBPS that is likely to change every year depending on the level of difficulty of the exam.</p>
                            ...
                            <p class="text-gray-500 mt-2">
                                IBPS Clerk Mains Exam constitute of 190 questions that should be completed in a time frame of 160 minutes.
                            </p>
                            <p class="text-gray-500 mt-2">
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-4" id="key_benefits">
                            <div class="flex items-center justify-center gap-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>Bank provides scholarship to meritorious children of bank employees.
                                </p>
                            </div>
                            <div class="flex items-center justify-center gap-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>100% benefits for employees & 75% for family and also the insurance policy.
                            ...
                            <div class="flex items-center justify-center gap-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>After a span of few years, you will become eligible for a promotional exam. If you clear this exam you can become a Trainee Officer (TO).

                                </p>
                            </div>
                            <div class="flex items-center justify-center gap-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>After that you come at the same level of PO, and all the future promotion prospects will be same as that of a PO.
