                ...
                <div class="w-full flex items-start justify-center mt-10 gap-5 max-lg:flex-col max-lg:gap-2">
                    <div class="w-[70%] flex flex-col items-center justify-center max-lg:w-full max-lg:gap-2">
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col" id="profileForm">
                            <p class="text-gray-500">The IBPS PO preliminary examination has a total duration of 1 hour and is conducted in online mode. It consists of 3 sections with a total of 100 questions and maximum score of 100 marks. There is negative marking in IBPS PO pre exam and 0.25 marks are deducted for each wrong answer. Candidates must clear the cut–off in all 3 sections to qualify for the IBPS PO Main exam. The section–wise details are given below:</p>
                                ...
                                <table class="w-full text-left rtl:text-right text-gray-500 ">
                                    <thead class=" text-gray-700 uppercase bg-gray-50  ">
                                        ...
                                        <tr class="bg-white border-b  dark:border-gray-200 border-gray-200">
                                            ...
                                            <td class="px-6 py-4">30</td>
                                            <td class="px-6 py-4 text-nowrap" rowspan="3">1 Hour
                            ...
                            <!-- <h2 class="text-2xl font-semibold ">Phase–2: IBPS Clerk Mains Examination
                            </h2> -->
                            <p class="text-gray-500 mt-2">
                                The structure of mains examination (online objective type) is as follows:


                            </p>

                            <div class="relative overflow-x-auto w-full max-lg:text-xs">
                                <table class="w-full text-left rtl:text-right text-gray-500 mt-5">
                                    <thead class=" text-gray-700 uppercase bg-gray-50  ">
                                        <tr>
                                            <th scope="col" class="px-6 py-3">Sr.No</th>
                                            <th scope="col" class="px-6 py-3">Name of Tests (Objective)</th>
                                        ...
                                        <tr class="bg-white border-b  dark:border-gray-200 border-gray-200">
                                            <td class="px-6 py-4">1</td>
                                            <td class="px-6 py-4">Reasoning & Computer Aptitude</td>
                                            <td class="px-6 py-4">45</td>
                                            <td class="px-6 py-4">60</td>
                                            <td class="px-6 py-4 text-nowrap">60 Minutes</td>
                                        </tr>
                                        <tr class="bg-white border-b  dark:border-gray-200 border-gray-200">
                                            <td class="px-6 py-4">2</td>
                                            <td class="px-6 py-4">English Language
                                            ...
                                            <td class="px-6 py-4 text-nowrap">40 Minutes</td>
                                        </tr>
                                        <tr class="bg-white border-b  dark:border-gray-200 border-gray-200">
                                            <td class="px-6 py-4">3</td>
                                            <td class="px-6 py-4">Data Analysis & Interpretation
                                            </td>
                                            <td class="px-6 py-4">35</td>
                                            <td class="px-6 py-4">60</td>
                                        ...
                                        <tr class="bg-white border-b  dark:border-gray-200 border-gray-200">
                                            ...
                                            <td class="px-6 py-4">General Economy & Banking Awareness
                                            </td>
                                            <td class="px-6 py-4">40</td>
                                            <td class="px-6 py-4">40</td>
                                        ...
                                        <tr class="bg-white border-b  dark:border-gray-200 border-gray-200">
                                            ...
                                            <td class="px-6 py-4">English Language (Letter Writing & Essay)
                                            </td>
                                            <td class="px-6 py-4">2</td>
                                            <td class="px-6 py-4">25</td>
                                            <td class="px-6 py-4 text-nowrap ">30 Minutes</td>
                                        </tr>
                                        <tr class="bg-white border-b  dark:border-gray-200 border-gray-200">
                                            <td class="px-6 py-4 text-center" colspan="2">Total</td>
                                            ...
                                            <td class="px-6 py-4 text-nowrap ">3 Hours</td>
                                        </tr>

                                </table>
                            </div>
                            <h2 class="text-2xl font-semibold mt-3">IBPS PO Interview</h2>
                            <p class="text-gray-500 mt-2">The candidates who have qualified the mains exam are called for a face to face interview which carries a maximum of 100 marks. The minimum qualifying marks in the interview is 40% (35% for SC⁄ST⁄OBC⁄PWD candidates).</p>
                            <p class="text-gray-500 mt-2">The final merit list is prepared on the basis of marks obtained in mains examination and interview. The final score is calculated by IBPS with weightage of marks given to the mains examination and interview in the ratio of 80:20 respectively.

                            </p>
                        </div>

                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-4" id="passwordForm">
                            <h2 class="text-3xl font-semibold max-lg:text-lg">The candidate must fulfil the following two criteria:
                            </h2>
