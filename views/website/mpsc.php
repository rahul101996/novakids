    ...
    <div class="min-h-screen">
        ...
        <div class="w-full flex items-center justify-center py-16 max-lg:py-10">
            <div class="w-[80%] flex flex-col items-center justify-center max-md:w-[85%] max-lg:w-[90%]">
                ...
                <h1 class="w-full text-4xl font-semibold mt-10">MPSC</h1>
                <p class="text-gray-500 mt-5 w-full">MPSC is a Government of Maharashtra organization which is responsible for conducting exams for recruitments to Maharashtra Government departments.
                </p>
                ...
                <div class="w-full flex items-start justify-center mt-10 gap-5 max-lg:flex-col max-lg:gap-2">
                    <div class="w-[70%] flex flex-col items-center justify-center max-lg:w-full max-lg:gap-2">
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col" id="profileForm">
                            <h2 class="text-2xl font-semibold">MPSC conducted in two stages</h2>
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Prelims Exam

                                </p>
                            </div>
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Main Exam (followed by Interview)

                                </p>
                            </div>
                            <p class="text-gray-500 mt-2">Prelims Exam is held in May-June, while Main Exam takes place in October of the same here. To participate in exams just you want to fill the MPSC application form, and you will get the intimations about dates. The examination is conducted for following relevant posts.

                            </p>
                            <h3 class="text-2xl font-semibold">Class 1 post:</h3>
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Deputy Collector
                            ...
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Deputy Superintendent of Police (DySP)
                            ...
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Assistant Commissioner Sales Tax
                            ...
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Deputy Registrar Co-operative Societies

                                </p>
                            </div>
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Deputy Chief Executive Officer
                            ...
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Superintendent State Excise Dept.
                            ...
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Block Development Officer (BDO) – A
                            ...
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Finance, Audit & Accounts Service – Group A
                            ...
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Chief Officer, Nagar Palika / Nagar Parishad – A
                            ...
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Tahasildar
                            ...
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Block Development Officer (BDO) – B

                                </p>
                            </div>
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Deputy Superintendent State Excise Dept.
                            ...
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Finance, Audit & Accounts Service – Group B
                            ...
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Nayab Tahsildar
                            ...
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Sales tax Officer
                                </p>
                            </div>
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Sales tax inspector
                                </p>
                            </div>
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Some posts in Mantralaya
                                </p>
                            </div>
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-3">Chief Officer, Nagar Palika / Nagar Parishad – B

                                </p>
                            </div>
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-3">Sub-registrar Cooperative Societies – B
                            ...
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-3">Taluka Inspector of Land Records (TILR)
                                </p>
                            </div>
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-" id="passwordForm">
                            <div class="space-y-6">
                                <!-- Title -->
                                <h2 class="text-2xl font-bold text-gray-800">📋 MPSC Exam Eligibility (As of 2025)</h2>

                                <!-- 1. Nationality -->
                                <div>
                                    <h3 class="text-xl font-semibold text-gray-700">1. Nationality</h3>
                                    <ul class="list-disc list-inside text-gray-600 mt-2">
                                        <li>Candidate must be a citizen of India.</li>
                                        <li>Must be a domicile of Maharashtra (for certain posts and reservations).</li>
                                    </ul>
                                </div>

                                <!-- 2. Educational Qualification -->
                                <div>
                                    <h3 class="text-xl font-semibold text-gray-700">2. Educational Qualification</h3>
                                    <ul class="list-disc list-inside text-gray-600 mt-2">
                                        <li>A bachelor’s degree from a recognized university in any stream.</li>
                                        <li>Final year students can also apply, but they must have the degree before the main exam.</li>
                                    </ul>
                                </div>

                                <!-- 3. Age Limit -->
                                <div>
                                    <h3 class="text-xl font-semibold text-gray-700">3. Age Limit <span class="text-sm text-gray-500">(as on notification date)</span></h3>
                                    <div class="overflow-x-auto mt-2">
                                        <table class="min-w-full text-left border border-gray-200 text-gray-600">
                                            <thead class="bg-gray-100 text-gray-700 text-sm uppercase">
                                                <tr>
                                                    <th class="px-4 py-2 border">Category</th>
                                                    <th class="px-4 py-2 border">Minimum Age</th>
                                                    <th class="px-4 py-2 border">Maximum Age</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td class="px-4 py-2 border">General (Open)</td>
                                                    <td class="px-4 py-2 border">19 years</td>
                                                    <td class="px-4 py-2 border">38 years</td>
                                                </tr>
                                                <tr class="bg-gray-50">
                                                    <td class="px-4 py-2 border">OBC</td>
                                                    <td class="px-4 py-2 border">19 years</td>
                                                    <td class="px-4 py-2 border">41 years</td>
                                                </tr>
                                                <tr>
                                                    <td class="px-4 py-2 border">SC/ST</td>
                                                    <td class="px-4 py-2 border">19 years</td>
                                                    <td class="px-4 py-2 border">43 years</td>
                                                </tr>
                                                <tr class="bg-gray-50">
                                                    <td class="px-4 py-2 border">Disabled Candidates</td>
                                                    <td class="px-4 py-2 border">19 years</td>
                                                    <td class="px-4 py-2 border">45 years</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <p class="text-sm text-gray-500 mt-1 italic">Note: Some posts (like Police Sub-Inspector) have specific physical and age requirements.</p>
                                </div>

                                <!-- 4. Number of Attempts -->
                                <div>
                                    <h3 class="text-xl font-semibold text-gray-700">4. Number of Attempts</h3>
                                    <p class="text-gray-600 mt-2">There is no limit on the number of attempts as long as the candidate is within the age limit.</p>
                                </div>

                                <!-- 5. Language Proficiency -->
                                <div>
                                    <h3 class="text-xl font-semibold text-gray-700">5. Language Proficiency</h3>
                                    <p class="text-gray-600 mt-2">Should be proficient in Marathi language (read, write, and speak).</p>
                                </div>
                            </div>
