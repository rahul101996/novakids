        ...
        <div class="w-full flex items-center justify-center py-16 max-lg:py-10">
            <div class="w-[80%] flex flex-col items-center justify-center max-md:w-[85%] max-lg:w-[90%]">
                <div class="w-full flex items-start justify-start gap-5 max-lg:text-xs max-lg:gap-2">
                    ...
                    <span>Online Vedic Maths</span>
                </div>
                <h1 class="w-full text-4xl font-semibold mt-10 max-lg: text-3xl max-lg:text-2xl">Online Vedic Maths</h1>
                <p class="text-gray-500 mt-5 w-full">Are you or your Child struggling with Math? Would you like to have fun with Math? If yes then this workshop is for you!
                </p>
                <p class="text-gray-500 w-full">
                    Then What are you waiting for? Let’s Join our LIVE VEDIC MATH WORKSHOP
                </p>
                <p class="text-gray-500 mt-4 font-semibold text-black cursor-pointer underline w-full">Click here to Register:</p>
                 ...
                 <div class="w-full flex items-start justify-center mt-10 gap-5 max-lg:flex-col max-lg:gap-2">
                    <div class="w-[70%] flex flex-col items-center justify-center max-lg:w-full max-lg:gap-2">
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col max-lg:p-0" id="profileForm">
                            ...
                            <section class="max-w-5xl mx-auto p-6 text-gray-700">
                                <h2 class=" text-3xl max-lg:text-2xl font-bold mb-4 text-blue-800 max-lg:text-2xl">What is Vedic Math?</h2>
                                <p class="mb-4">
                                    Vedic Mathematics is a collection of ancient Indian techniques/sutras to solve mathematical problems in a faster and simpler way. Derived from the Vedas, particularly the <strong>Atharva Veda</strong>, it was rediscovered in the early 20th century by <strong>Bharati Krishna Tirthaji Maharaj</strong>. Vedic Math comprises <strong>16 sutras</strong> (formulas) and <strong>13 sub-sutras</strong> that simplify arithmetic, algebra, geometry, and calculus.
                                </p>

                                <h3 class="text-2xl font-semibold mt-6 mb-2 text-blue-700">🔍 Key Features of Vedic Math:</h3>
                                <ul class="list-disc pl-6 space-y-2">
                                    <li><strong>💡 Speed & Accuracy:</strong> Enhances calculation speed with mental math tricks.</li>
                                    <li><strong>🧠 Boosts Mental Agility:</strong> Encourages thinking in patterns, increasing logical and creative ability.</li>
                                    <li><strong>📉 Reduces Dependency on Calculator:</strong> Ideal for quick calculations in competitive exams.</li>
                                    <li><strong>🧮 Simplified Methods:</strong> Complex calculations like square roots, cube roots, and algebraic identities become easy.</li>
                                </ul>

                                <h3 class="text-2xl font-semibold mt-6 mb-2 text-blue-700">📘 Applications of Vedic Math:</h3>
                                <ul class="list-disc pl-6 space-y-2">
                                    <li>Competitive Exams (IBPS, SSC, UPSC, CAT, etc.)</li>
                                    <li>School/College Math</li>
                                    <li>Logical Reasoning & Data Interpretation</li>
                                    <li>Business & Daily Life Calculations</li>
                                </ul>

                                <h3 class="text-2xl font-semibold mt-6 mb-2 text-blue-700">🧾 Examples of Vedic Math Tricks:</h3>
                                <ul class="list-disc pl-6 space-y-2">
                                    <li><strong>Multiplication:</strong> Multiply numbers like <code>98 × 97</code> in seconds using the <em>“Base Method”</em>.</li>
                                    <li><strong>Squaring Numbers:</strong> Use <em>“Ekadhikena Purvena”</em> sutra to square numbers ending in 5 (e.g., <code>25² = 625</code>).</li>
                                    <li><strong>Division:</strong> Use <em>“Nikhilam Sutra”</em> for fast division with numbers close to base values like 10, 100, etc.</li>
                                </ul>

                                <h3 class="text-2xl font-semibold mt-6 mb-2 text-blue-700">🎯 Why Learn Vedic Math?</h3>
                                <ul class="list-disc pl-6 space-y-2">
                                    <li>Saves time in exams</li>
                                    <li>Builds confidence in numbers</li>
                                    <li>Makes math fun and engaging</li>
                                    <li>Enhances problem-solving techniques</li>
                                </ul>
                            </section>
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-" id="passwordForm">
                            <h2 class=" text-3xl max-lg:text-2xl font-semibold  ">
                                Who Can learn?:
                            </h2>
                            <div class="flex items-center justify-center gap-3 mt-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Students of Grade 4 onwards up to Grade 12.
                                </p>
                            </div>

                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Competitive Entrance Exam Aspirants.
                                </p>

                            </div>
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">professional degree course students.
                                </p>

                            </div>
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Parents,housewives,working women & Professionals.
                                </p>
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-" id="key_benefits">
                            <div class="mb-6">
                                <h2 class="text-lg font-semibold mb-2">🎁 Key Benefits of Vedic Math:</h2>
                                <ul class="list-disc list-inside text-gray-600 space-y-1">
                                    <li>✅ <strong>Faster Calculations:</strong> Solve complex arithmetic in seconds with simple tricks and mental shortcuts.</li>
                                    <li>✅ <strong>Boosts Concentration & Memory:</strong> Encourages mental calculations, improving focus, retention, and brain power.</li>
                                    <li>✅ <strong>Reduces Silly Mistakes:</strong> Clear, logical steps minimize common calculation errors.</li>
                                    <li>✅ <strong>Exam Advantage:</strong> Ideal for competitive exams like IBPS, SSC, UPSC, CAT, etc., where time-saving is crucial.</li>
                                    <li>✅ <strong>Strengthens Math Foundation:</strong> Improves number sense and builds a strong base in arithmetic, algebra, and beyond.</li>
                                    <li>✅ <strong>Increases Confidence:</strong> Simplified methods reduce math anxiety and boost self-esteem in students.</li>
                                    <li>✅ <strong>Fun & Engaging:</strong> Turns math into a game-like experience with patterns and shortcuts.</li>
                                    <li>✅ <strong>Universal Application:</strong> Useful for students, professionals, teachers, and anyone dealing with numbers in daily life.</li>
                                </ul>
                            </div>
                        </div>
