    ...
    <div class="min-h-screen">
        ...
        <div class="w-full flex items-center justify-center py-16 max-lg:py-10">
            <div class="w-[80%] flex flex-col items-center justify-center max-md:w-[85%] max-lg:w-[90%]">
                ...
                <h1 class="w-full text-4xl font-semibold mt-10  max-lg:text-3xl">SSC CHSL (10+2)
                ...
                <p class="text-gray-500 mt-5 w-full">SSC broadly conducts two types of examinations.
                </p>
                ...
                <div class="w-full flex items-start justify-center mt-10 gap-5 max-lg:flex-col max-lg:items-start">
                    <div class="w-[70%] flex flex-col items-center justify-center max-lg:w-full">
                        ...
                        <div class="w-full flex items-start p-6  justify-center flex-col " id="profileForm">
                          ...
                          <div class="space-y-6 max-lg:w-full  max-lg:mx-auto">
                                <!-- Overview -->
                                <div>
                                    <h2 class="text-2xl font-semibold mb-2 ">📝 SSC CHSL Exam Overview</h2>
                                    <p class="text-gray-700">
                                        The SSC CHSL exam is conducted by the Staff Selection Commission (SSC) for recruitment to various posts in government ministries and departments for candidates who have completed 10+2 (Higher Secondary) education.
                                    </p>
                                </div>

                                <!-- Posts -->
                                <div>
                                    <h2 class="text-xl font-semibold mb-2">📌 Posts under SSC CHSL</h2>
                                    <ul class="list-disc pl-6 text-gray-700 grid grid-cols-2 gap-y-1 max-sm:grid-cols-1">
                                        ...
                                        <li>Postal Assistant (PA) / Sorting Assistant (SA)</li>
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-700"><strong>Education:</strong> Must have passed 12th Standard (10+2) or equivalent examination.</p>
                                    <p class="text-gray-700 mt-1"><strong>Age Limit:</strong> 18 to 27 years (Age relaxation as per government norms).</p>
                                </div>

                                <!-- Exam Structure -->
                                <div>
                                    <h2 class="text-xl font-semibold mb-2">🏗️ Exam Structure</h2>

                                    <!-- Tier I -->
                                    <div class="max-lg:mb-6">
                                        <h3 class="text-lg font-semibold mb-1">📍 Tier I – Computer-Based Examination</h3>
                                        <ul class="list-disc pl-6 text-gray-700 mb-2 space-y-1">
                                            <li><strong>Mode:</strong> Online</li>
                                            <li><strong>Type:</strong> Objective-type questions</li>
                                            <li><strong>Duration:</strong> 60 minutes</li>
                                            <li><strong>Negative Marking:</strong> 0.50 marks for each wrong answer</li>
                                        </ul>

                                        <div class="overflow-x-auto mb-4 max-lg:mt-6 max-lg:text-xs">
                                            <table class="w-full text-left text-gray-500 border border-gray-200">
                                                ...
                                                <tbody>
                                                    <tr class="bg-white border-b border-gray-200">
                                                        <td class="px-6 py-4">General Intelligence</td>
                                    ...
                                    <!-- Tier II -->
                                    <div>
                                        <h3 class="text-lg font-semibold mb-1">📍 Tier II – Descriptive Paper</h3>
                                        <ul class="list-disc pl-6 text-gray-700 mb-2 space-y-1">
                                            <li><strong>Mode:</strong> Pen & Paper (Offline)</li>
                                            <li><strong>Type:</strong> Essay / Letter / Application writing</li>
                                            <li><strong>Language:</strong> English or Hindi</li>
                                    ...
                                    <!-- Tier III -->
                                    <div>
                                        <h3 class="text-lg font-semibold mb-1">📍 Tier III – Skill Test / Typing Test</h3>
                                        <ul class="list-disc pl-6 text-gray-700 space-y-1">
                                            <li><strong>Applicable only to qualified candidates</strong></li>
                                            <li><strong>For DEO:</strong> Data entry speed of 8,000 key depressions per hour</li>
                                            <li><strong>For LDC/JSA:</strong> Typing speed of 35 w.p.m. (English) or 30 w.p.m. (Hindi)</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <!-- Key Benefits -->
                                <div>
                                    <h2 class="text-xl font-semibold mb-2">✅ Key Benefits of Clearing SSC CHSL</h2>
                                    <ul class="list-disc pl-6 text-gray-700 space-y-1">
                                        <li>Secure Central Government Job</li>
                                        <li>Timely Promotions & Salary Increments</li>
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-2" id="passwordForm">
                            <div class="flex items-center justify-start gap-3 w-full mt-5 ">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>Citizenship: Candidate must be a citizen of India.
                                </p>
                            </div>
                            <div class="flex items-center justify-start gap-3 w-full mt-5 ">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p> Age Limit: 18–27 years (Candidates born not before 02–08–1991 and not later than 01–08–2000).
                                </p>
                            </div>
                            <div class="flex items-center justify-start gap-3 w-full mt-5 ">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>Educational Qualification: Candidates must have passed 12th Standard or equivalent examination from a recognized Board or University.
                                </p>
                            </div>
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-4" id="key_benefits">
                            <div class="flex items-center justify-start gap-3 w-full mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>In future you can get promoted to the level of Assistant⁄Upper division Clerk, Division Clerk and Section Officer.
                                </p>
                            </div>
                            <div class="flex items-center justify-start gap-3 w-full mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>One of the main advantages of CHSL is you get a good job at the early stage of your career and get better future prospects.
                                </p>
                            </div>
