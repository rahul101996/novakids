...
<div class="h-[100vh] w-[59%] max-md:w-full z-[50] fixed top-0 right-0 w-full flex items-center justify-center transform translate-x-full transition-transform duration-[0.6s] ease-in-out"
    id="AddToCartSidebar">
