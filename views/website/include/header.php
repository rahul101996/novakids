...
src="https://www.facebook.com/tr?id=1525213108842821&ev=PageView&noscript=1"
/></noscript>
<!-- Google Tag Manager -->
...
<!-- End Meta Pixel Code -->
    ...
    <title>Vikas Sawants Academy | Best Online Coaching in India for Banking, SSC, PSC, MBA</title>
...
<button id="scrollToggleBtn"
    ...
    <!-- Arrow Icon -->
    <svg id="scrollIcon" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
        viewBox="0 0 24 24" stroke="currentColor">
        <!-- Down Arrow Default -->
        <path id="scrollPath" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            d="M19 9l-7 7-7-7" />
    </svg>
</button>
<script>
