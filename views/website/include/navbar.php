...
<nav class="sticky w-full flex flex-col items-center justify-between shadow-md z-50 top-0 bg-white">
    ...
    <div class="w-full flex items-center justify-between">
        ...
        <div class="flex items-center absolute left-1/2 transform -translate-x-1/2">
            <a href="/" class="block">
                <img src="/public/logos/newuniverse.png" alt="Logo" class="h-12">
            </a>
        </div>


        <!-- Right: Icons -->
        <div class="flex gap-1 items-center ml-auto pr-12 py-1.5">
            <div class="flex items-center">
                <!-- <input type="text" placeholder="Search..."
                    class="search-expand bg-black/10 text-black placeholder-black/70 px-3 py-1 rounded-full text-sm border-0 focus:outline-none focus:ring-2 focus:ring-white/30">
                <button
                ...
                <button id="openSearch"
                    class="text-black p-2 rounded-full hover:bg-black/10 transition-all duration-300 active:scale-95">
                    <!-- <i class="fas fa-search text-lg"></i> -->
            ...
            <div id="searchOverlay"
                ...
                <!-- Search Box -->
                <div class="bg-white w-[50%] h-[75vh] relative p-8 shadow-lg animate-slideDown flex flex-col">
                    <!-- Close Button -->
            ...
            <div id="loginModal"
                ...
                <!-- Modal Container -->
                <div
                    class="relative flex flex-col md:flex-row w-[95%] md:w-[70%] max-w-5xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] animate-fade-in">

                    <!-- Close Button -->
                    <button id="closeLogin"
                        class="absolute top-3 right-3 z-40 text-gray-600 hover:text-black text-xl animate-rotate-pingpong">
                        ✕ </button>

                    <!-- Left Section -->
                    <div
                        class="flex flex-col justify-center items-center w-full md:w-[55%] bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white p-10 relative">
                        <!-- Decorative circle -->
                        <div
                            class="absolute -top-20 -left-20 w-60 h-60 bg-gradient-to-tr from-yellow-500/30 to-orange-500/20 rounded-full blur-3xl">
                        </div>
                        <img src="/public/logos/logo-white.png" alt="Logo" class="mb-6 h-24 drop-shadow-lg">
                        <h2 class="text-3xl md:text-4xl font-extrabold text-center leading-snug tracking-tight">
                    ...
                    <!-- Right Section -->
                    <div class="flex flex-col justify-center w-full md:w-[45%] bg-white p-10 relative">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 text-center mb-8">Start Your Style Journey</h3>

                        <!-- Floating label input -->
                        <div class="w-full mb-5">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Enter Mobile Number</label>
                            <div
                                class="flex items-center border border-gray-300 rounded-lg focus-within:ring-2 focus-within:ring-black transition">
                                <span class="px-3 text-gray-500">+91</span>
                                <input type="tel" placeholder="Enter mobile number"
                                    class="w-full px-3 py-2 outline-none bg-transparent text-gray-800 placeholder-gray-400">
                            </div>
                        </div>
                        ...
                        <div class="flex items-center mb-6">
                            <input type="checkbox" id="offers"
                                class="mr-2 rounded border-gray-400 text-black focus:ring-black">
