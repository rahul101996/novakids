    ...
    <div class="min-h-screen">
        ...
        <div class="w-full flex items-center justify-center py-16 max-lg:py-10">
            <div class="w-[80%] flex flex-col items-center justify-center max-md:w-[85%] max-lg:w-[90%]">
                <div class="w-full flex items-start justify-start gap-5 max-lg:text-xs max-lg:gap-2">
                    ...
                    <span>Vedic Maths- Teacher Training Programme</span>
                </div>
                <h1 class="w-full text-4xl font-semibold mt-10 max-lg: text-3xl max-lg:text-2xl">Vedic Maths- Teacher Training Programme</h1>
                <p class="text-gray-800 text-2xl mt-5 w-full font-semibold">Become a certified Vedic Maths teacher in 40 hours
                </p>
                <p class="text-gray-500 w-full">
                    This is an excellent opportunity to be associated with a program that can make you your own boss, and earn a lucrative fortune by training yourself and up-skill others.


                </p>
                <p class="text-gray-500 w-full mt-5">
                    Undoubtedly, Vikas Sawants Academy introduce one of the best Vedic Maths Course Online, which helps the candidate to learn Maths in easy and fun way. It is definitely an opportunity for those with interest in teaching, and ready for training students in an inventive way with help of various tools. Vedic Maths Teacher training especially brings endless earning opportunity to earn and retirement free job at own choice of terms.
                </p>
                <h2 class="text-2xl font-semibold mt-10 w-full">40 Hours Rigorous Training</h2>
                <h3 class="text-2xl font-semibold mt-6 w-full">
                    24 x 7 Teacher Availability
                </h3>
                <h4 class="text-lg font-semibold mt-6 w-full">Online Vedic Maths Programme Teacher Training Details:

                </h4>
                <p class="text-gray-500 w-full">Training Duration: 40 hours sessions of 1 hour each
                    Fees: Rs.18000 (payable in 2 installments)</p>
                ...
                <div class="w-full flex items-start justify-center mt-10 gap-5 max-lg:flex-col max-lg:gap-2">
                    <div class="w-[70%] flex flex-col items-center justify-center max-lg:w-full max-lg:gap-2">
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col max-lg:p-0" id="profileForm">
                            <div class="max-w-4xl mx-auto p-6 text-gray-800 space-y-6 max-lg:w-full">
                                <h2 class="text-2xl font-bold text-blue-800">Overview: Vedic Math Teacher Training Course</h2>
                                <p>
                                    The Vedic Math Teacher Training Course is designed to empower aspiring educators, parents, and math enthusiasts with the ancient and powerful techniques of Vedic Mathematics. Rooted in ancient Indian knowledge, Vedic Math offers simplified and intuitive approaches to solve complex arithmetic problems quickly and accurately.
                                </p>
                                <p>
                                    This course equips participants not only with deep conceptual clarity but also with effective teaching methodologies, enabling them to confidently teach Vedic Math to students of various age groups.
                                </p>

                                <h3 class="text-xl font-semibold text-blue-700">📚 Course Objectives</h3>
                                <ul class="list-disc list-inside space-y-1">
                                    <li>Understand the foundation and origin of Vedic Mathematics.</li>
                                    <li>Learn 16 sutras (formulas) and their applications in arithmetic, algebra, and geometry.</li>
                                    <li>Develop speed and accuracy in calculations using mental math techniques.</li>
                                    <li>Master the teaching strategies to conduct engaging Vedic Math sessions.</li>
                                    <li>Gain a recognized certification to begin your journey as a Vedic Math educator.</li>
                                </ul>

                                <h3 class="text-xl font-semibold text-blue-700">✅ Key Highlights</h3>
                                <ul class="list-disc list-inside space-y-1">
                                    <li>100% Online + Flexible Timings</li>
                                    <li>Suitable for teachers, parents, tuition tutors, and school coordinators</li>
                                    <li>Live sessions with Vedic Math experts</li>
                                    <li>Assignments and practice material provided</li>
                                    <li>Certification upon successful completion</li>
                                </ul>

                                <h3 class="text-xl font-semibold text-blue-700">🎓 Who Can Enroll?</h3>
                                <ul class="list-disc list-inside space-y-1">
                                    <li>School teachers (Math or General subjects)</li>
                                    <li>Competitive exam trainers</li>
                                    <li>Parents looking to support their children</li>
                                    <li>Education entrepreneurs</li>
                                    <li>Math enthusiasts & students above age 15</li>
                                </ul>

                                <h3 class="text-xl font-semibold text-blue-700">🔑 Benefits</h3>
                                <ul class="list-disc list-inside space-y-1">
                                    <li>Boost your teaching profile with a specialized skill</li>
                                    <li>Start your own Vedic Math classes</li>
                                    <li>Improve students’ interest and performance in math</li>
                                    <li>Earn additional income by offering Vedic Math training</li>
                                </ul>
                            </div>
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-" id="passwordForm">
                            ...
                            <div class="flex items-center justify-center gap-3 mt-2">
                                ...
                                <p class="text-gray-500 mt-2">Maths Teachers + Working Professionals
                            ...
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Vedic Maths Franchise Owners
                            ...
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Adults who want to teach this subject
                            ...
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Parents
                            ...
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Work at home Moms
                            ...
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Entrepreneurs
                                </p>

                            </div>
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p class="text-gray-500 mt-2">Maths Enthusiasts

                                </p>

                            </div>
                            <p class="text-gray-500 mt-4">
                                This program is extensive, practical oriented and power packed which will help the students to remove the fear of Maths and help them to score very well in Maths increasing their overall percentage.


                            </p>
                            <p class="text-gray-500 mt-2">
                                If you have passion for teaching & love being with kids Online Vedic Maths Programme Teacher Training Course is for you. Enrol today at VSA state-of-art centralised teacher training academy.


                            </p>
                            <h2 class="text-2xl font-semibold mt-4">
                                Online Vedic Maths Programme Teacher Training Details:


                            </h2>
                            <p class="text-gray-500 mt-2">Training Duration: 40 hours sessions of 1 hour each
                            </p>
                            <p class="text-gray-500 ">Fees: Rs.18000 (payable in 2 installments)

                            </p>

                        </div>
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-" id="key_benefits">
                            <h2 class="text-2xl font-semibold">
                                Top 6 reasons to become certified vedic maths teacher:
                            </h2>
                            <span class="text-lg font-semibold mt-5">Love Maths:</span>
                            <p class="text-gray-500 mt-1">Eliminate the fear of maths from the hearts of the children once and for all. Make them fall in love with mathematics so that they could score better.</p>

                            <span class="text-lg font-semibold mt-5">Start a math venture:</span>
                            <p class="text-gray-500 mt-1">With enough experience, you can start your own venture around maths education. You can consider doing it by yourself or you can apply for the Vedic Maths Forum franchise plan.</p>

                            <span class="text-lg font-semibold mt-5">Continuous education:</span>
                            <p class="text-gray-500 mt-1">You learn new Vedic Maths methods and techniques to get better in your performance as a teacher.</p>

                            <span class="text-lg font-semibold mt-5">For a bright future:</span>
                            <p class="text-gray-500 mt-1">With Vedic Maths skills, you can avail great job opportunities whether it’s online or offline. Let your skills do the talking</p>

                            <span class="text-lg font-semibold mt-5">Make a difference:</span>
                            <p class="text-gray-500 mt-1">Remember, by taking up this course you contribute towards a better future for your community and the upcoming generation.</p>
                            <span class="text-lg font-semibold mt-5">Get an edge:</span>
                            <p class="text-gray-500 mt-1">With Vedic Math skills, you can be the most popular teacher of your school and gain admiration from students, parents and as well as your peers for your performance.

                            </p>
                            <span class="text-lg font-semibold mt-5">Online Vedic Maths Programme Teacher Training Details:</span>
                            <p class="text-gray-500 mt-1">Training Duration: 40 hours sessions of 1 hour each</p>
                            <p class="text-gray-500 mt-1">Fees: Rs.18000 (payable in 2 installments)</p>
                        </div>
        ...
        <div class="w-full flex items-center justify-center">
            <div class="w-[80%] flex flex-col items-center justify-center gap-4">
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">Bank Exam Online Coaching
                    </h2>
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">Course For Banking
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">IBPS Online Coaching
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">IBPS PO Online Coaching
                    </h2>
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">IBPS PO Online Coaching Fee
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">IBPS Clerk Online Coaching
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">IBPS RRB Online Coaching
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">IBPS RRB PO Online Coaching
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">IBPS RRB Clerk Online Coaching
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">SBI Clerk Online Coaching
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">SBI Clerk Online Coaching Fee
                    </h2>
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">RBI Grade B Online Coaching
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">RBI Grade B Online Coaching Fees
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">Bank Exam Online Coaching in India
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">Bank Exam Online Courses by VSA
                    </h2>
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">Bank Exam Online Coaching in Hindi
                    </h2>
                ...
                <div class="w-full flex flex-col items-start justify-center">
                    <h2 class=" text-3xl max-lg:text-2xl font-semibold">Bank Exam Online Coaching Features
                ...
                <section class="bg-white py-12 px-4 sm:px-6 lg:px-8 max-lg:px-0">
                    <div class="max-w-7xl mx-auto max-lg:w-full">
                        ...
                        <div class="text-center mb-12">
                            <h2 class=" text-3xl max-lg:text-2xl font-bold text-gray-800">Key Features of Our Bank Exam Online Coaching</h2>
