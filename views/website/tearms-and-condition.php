    ...
    <div class="w-full  bg-white flex justify-center items-start my-16 max-md:my-8">
        <div class="w-[60%] max-md:w-[90%] flex items-center justify-center flex-col">
            ...
            <div class="text-gray-600 mt-6">
                <p>
                    For the purpose of these Terms and Conditions, the terms "we", "us", "our" used anywhere on this page shall mean <strong>NOVAKIDS</strong>, whose registered/operational office is Unit no. 135, Globe Business Park, Ambarnath Badlapur Road, Ambarnath West, Dist. Thane, Maharashtra 421501. The terms "you", “your”, "user", or “visitor” shall mean any natural or legal person who is visiting our website and/or has agreed to purchase from us. Your use of the website and/or purchase from us is governed by the following Terms and Conditions:
                    ...
                    Our website contains material which is owned by or licensed to us. This material includes, but is not limited to, the design, layout, look, appearance, and graphics. Reproduction is prohibited other than in accordance with the copyright notice, which forms part of these Terms and Conditions. All trademarks reproduced on our website which are not the property of, or licensed to, the operator are acknowledged on the website. Unauthorized use of information provided by us shall give rise to a claim for damages and/or may be considered a criminal offense.

                    From time to time, our website may also include links to other websites. These links are provided for your convenience to provide further information. You may not create a link to our website from another website or document without <strong>NOVAKIDS</strong>’s prior written consent.
