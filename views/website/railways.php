                    ...
                    <div class="w-[70%] flex flex-col items-center justify-center max-lg:w-full max-lg:gap-2">
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col" id="profileForm">
                            ...
                            <p class="mt-2 text-gray-500">
                                Candidates who fulfill the minimum eligibility criteria for Railway Exam can apply through proper channel. The Indian railways are generally divided and sub-divided into zones, divisions and departments, each controlling a particular task. Every division has a certain number of technical and non-technical departments, which form the base structure on which railways operates. For more information about Eligibility Criteria for Railway Exam, check below section of this page of privatejobshub.in
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-2" id="passwordForm">
                            <h3 class="text-2xl font-semibold">Railway Exam Eligibility Criteri</h3>
                            <div class="flex items-center justify-start gap-3 w-full mt-5 ">
                                ...
                                <p>RRB Eligibility Criteria
                                </p>
                            </div>
                            <div class="flex items-center justify-start gap-3 w-full mt-1 ">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p> Railways Technical Cadre Exam Eligibility Criteria:
                                </p>
                            </div>
                            <div class="flex items-center justify-start gap-3 w-full mt-1 ">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>Educational Qualification: Candidates must hold Bachelor Degree in relevant discipline with good academic records from well recognized University/ Institute. Hindi Type writing on Computer and Typing Skill in English language is desirable.
                                </p>
                            </div>
                            <div class="flex items-center justify-start gap-3 w-full mt-1 ">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-4" id="key_benefits">
                            <p class="text-gray-500">Contenders if you want to know more about the Railway Exam Pattern 2020 then keep visiting our web portal on regular basis or subscribe our free email service to remain updated via email. You will acquire regular updates about score card; admit card and other career related notifications directly in your mail box. You can also follow on facebook and Google+ and you can also bookmark the web portal by pressing Ctr+D option.
