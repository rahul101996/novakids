    ...
    <div class="min-h-screen">
        ...
        <div class="w-full flex items-center justify-center py-16 max-lg:py-10">
            <div class="w-[80%] flex flex-col items-center justify-center max-md:w-[85%] max-lg:w-[90%] ">
                ...
                <h1 class="w-full text-4xl font-semibold mt-10">SBI PO Exams </h1>
                <p class="text-gray-500 mt-5">The State Bank of India is the country’s oldest bank and has widespread network in India. It is headquartered in Mumbai. SBI conducts online objective prelims and mains exams. It is one of the most desired competitive exams in India as it is offering a prestigious career option to the candidates looking for banking and government sector jobs.
                </p>
                <div class="w-full flex items-start justify-center mt-10 gap-5 max-lg:flex-col max-lg:gap-2">
                    <div class="w-[70%] flex flex-col items-center justify-center max-lg:w-full max-lg:gap-2">
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col" id="profileForm">
                            <p class="text-gray-800 text-2xl max-lg:text-lg font-semibold mt-5">There is online objective type preliminary test followed by online objective mains test and online descriptive test. Mains exam is followed by GD and interview.
                            </p>
                            <h2 class="text-lg text-gray-500  mt-5"><span class="font-semibold text-gray-800">Phase I – Preliminary Exam: </span>Preliminary Examination consisting of objective tests for 100 marks and it is conducted online. This test would be of 1 hour duration consisting of 3 sections as follows:
                            </h2>
                            ...
                            <div class="flex items-center justify-center gap-3 mt-2">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>Mains Examination consists of objective tests for 200 marks and descriptive test for 50 marks. Both the objective and descriptive tests are online. Candidates have to answer descriptive test by typing on the computer. Immediately after completion of objective test, descriptive test is administered.
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-4" id="passwordForm">
                            ...
                            <p class="mt-1 text-gray-500">Not below 21 years and not above 30 years i.e. candidates must have been born not earlier than 02.04.1987 and not later than 01.04.1996 (both days inclusive)
                        ...
                        <div class="w-full flex items-start p-6 justify-center flex-col hidden gap-4" id="key_benefits">
                            <div class="flex items-center justify-center gap-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>The basic salary of a newly joined SBI PO is more than that of a PO who has joined in any other public sector bank.
                                </p>
                            </div>
                            <div class="flex items-center justify-center gap-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                            ...
                            <div class="flex items-center justify-center gap-3">
                                <i class="fa-solid fa-circle-check text-[#543cdf]" aria-hidden="true"></i>
                                <p>SBI offers the best promotion policy among all the public sector banks in India and it rewards its top performers accordingly by giving them challenging assignments.
