...
<body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="flex justify-between">
                                    ...
                                    <span class="btn btn-primary" onclick="addpages()">Add</span>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table" id="pagesTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class=" uppercase">Pages</th>
                                                <th class=" uppercase">Pages Name</th>
    ...
    ?>
    <script src="/public/customjs/pages.js"></script>
</body>
